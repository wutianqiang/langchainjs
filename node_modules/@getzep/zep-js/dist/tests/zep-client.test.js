...
describe("ZepClient", () => {
    ...
    let mock;
    beforeEach(() => {
        axiosInstance = axios_1.default.create({ baseURL: "http://localhost:8000" });
        client = new __1.ZepClient("http://localhost:8000", axiosInstance);
        mock = new axios_mock_adapter_1.default(axiosInstance);
    });
    afterEach(() => {
        mock.reset();
    });
    ...
    describe("addMemory", () => {
        it("should add a memory to a session", () => __awaiter(void 0, void 0, void 0, function* () {
            const memoryData = new __1.Memory({
                messages: [
                    new __1.Message({ role: "human", content: "Hello again!" }),
                ],
                summary: new __1.Summary({
                    uuid: "",
                    created_at: "",
