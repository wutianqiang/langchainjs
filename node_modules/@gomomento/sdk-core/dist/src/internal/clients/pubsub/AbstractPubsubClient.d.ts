import { CredentialProvider, TopicPublish, TopicItem, MomentoLogger, TopicSubscribe, SubscribeCallOptions } from '../../../index';
...
export declare abstract class AbstractPubsubClient implements IPubsubClient {
    ...
    protected handleSubscribeError(options: PrepareSubscribeCallbackOptions, momentoError: TopicSubscribe.Error, isRstStreamNoError: boolean): void;
}
