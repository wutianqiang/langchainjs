 ...
 */
export declare type Collation = {
    case: Case;
};
/**
 * A VectorQuery allows you to perform nearest neighbor search.
 */
export declare type VectorQuery = {
    /**
