...
function SearchField(typeOrOptions, options) {
    return function (target, propertyName) {
        ...
        const defaultFieldOption = { searchIndex: true };
        fieldOptions = Object.assign(Object.assign({}, defaultFieldOption), fieldOptions);
        (0, globals_1.getDecoratorMetaStorage)().searchFields.push({
            name: propertyName,
            type: propertyType,
